						...
						<div id="specification" class="summary-wrap clearfix">
							<#list specificationItemList as specificationItem>
								<dl>
									...
									<#list specificationItem.attributeValue as value>
										<dd><a href="javascript:;" class="{{isSelected('${specificationItem.attributeName}','${value}')?'selected':''}}" ng-click="selectSpecification('${specificationItem.attributeName}','${value}')">${value}<span title="点击取消选择">&nbsp;</span></a></dd>
									</#list>
								</dl>
							</#list>
						</div>
